...
import { employerNotifications } from '../../data/notifications.js';
...
function EmployerNotificationsPage() {
  const [items] = useState(employerNotifications);
      ...
      <div className="space-y-3">
        ...
        {items.length === 0 ? (
          <p className="rounded-xl bg-white p-6 text-center text-sm text-gray-500 shadow-sm">
            You're all caught up. New matches and updates will appear here.
          </p>
        ) : null}
      </div>
    </div>
